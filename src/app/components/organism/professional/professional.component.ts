  ...
  public projects: Project[] = [
    {
      ...
      alt: 'An example figure of a design system, it contains a blood orange and white color scheme with somebasic buttons, inputs, and typography.',
    ...
    },
    {
      ...
      alt: 'An example figure of a scaffolding script running in a terminal, green text exhibits that the building of a new project has been successful.',
    ...
    },
    {
      ...
      alt: 'An image of a laptop containing a web app of sorts with the developer tools sidebar open.',
      caption: ''
    },
    {
      ...
      alt: 'An image of an HTC Vive Controller on a plain background',
      caption: ''
    },
  ];
}
